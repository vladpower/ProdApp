...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.rules_tw.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        self.rules_tw.setSelectionMode(QtWidgets.QAbstractItemView.SingleSelection)
        self.rules_tw.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        ...
        self.attrs_pb = QtWidgets.QPushButton(Form)
        self.attrs_pb.setObjectName("attrs_pb")
        self.horizontalLayout_3.addWidget(self.attrs_pb)
    ...
    def retranslateUi(self, Form):
        ...
        self.attrs_pb.setText(_translate("Form", "Список признаков"))
